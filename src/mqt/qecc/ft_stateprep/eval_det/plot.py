...
for index, row in data.iterrows():
    verify_0 = DeterministicVerification(eval(row["verification_stabs_0"], eval_names), eval(row["recovery_stabs_0"], eval_names), eval(row["flags_0"], eval_names))
    verify_1 = DeterministicVerification(eval(row["verification_stabs_1"], eval_names), eval(row["recovery_stabs_1"], eval_names), eval(row["flags_1"], eval_names))
    # add column
...
stats_columns = ["verification_stabs_0",	"recovery_stabs_0", "flags_0", "verification_stabs_1",	"recovery_stabs_1", "flags_1"]
