...
INSTANTIATE_TEST_SUITE_P(CorrectableSingleBitErrsSteane,
                         UniquelyCorrectableErrTestOriginal,
                         testing::Values(std::vector<bool>{0, 0, 0, 0, 0, 0, 0},
...
INSTANTIATE_TEST_SUITE_P(UptoStabCorrSteane, InCorrectableErrTestOriginal,
                         testing::Values(std::vector<bool>{0, 0, 0, 1, 0, 0, 0},
...
INSTANTIATE_TEST_SUITE_P(UptoStabCorrSteane, UpToStabCorrectableErrTestOriginal,
                         testing::Values(std::vector<bool>{0, 0, 0, 0, 0, 0, 1},
                                         std::vector<bool>{1, 1, 0, 0, 0, 0, 0},
                                         std::vector<bool>{0, 0, 0, 0, 1, 1, 0},
                                         std::vector<bool>{1, 0, 0, 0, 0, 0,
                                                           1}));
