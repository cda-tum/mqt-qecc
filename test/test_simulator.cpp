...
TEST(DecodingSimulatorTest, TestRuntimeSim) {
  ...
  try {
    ...
    DecodingSimulator::simulateAverageRuntime(rawOut, testOut, physicalErrRate,
                                              nrRuns, codePath, nrSamples,
...
TEST(DecodingSimulatorTest, TestPerformanceSim) {
  ...
  try {
    DecodingSimulator::simulateWER(rawOut, testOut, minErate, maxErate,
                                   runsPerRate, code, stepSize,
